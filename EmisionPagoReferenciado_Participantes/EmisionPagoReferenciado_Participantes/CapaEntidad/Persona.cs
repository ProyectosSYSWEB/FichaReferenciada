...
namespace CapaEntidad
{
    public class Persona
    {
        ...
        private string _EventoStr;

        public string EventoStr
        {
            get { return _EventoStr.Trim(); }
            set { _EventoStr = value.Trim(); }
        }

        private string _EventoEspecificacion;

        public string EventoEspecificacion
        {
            get { return _EventoEspecificacion.Trim(); }
            set { _EventoEspecificacion = value.Trim(); }
        }
        ...
        private string _Constancia=string.Empty;
