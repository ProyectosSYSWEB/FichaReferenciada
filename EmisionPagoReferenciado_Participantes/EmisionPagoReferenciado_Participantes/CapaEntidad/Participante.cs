...
namespace CapaEntidad
{
    public class Participante:Persona
    {
        ...
        private string _ComponentesExtras;
        public string ComponentesExtras
        {
            get { return _ComponentesExtras; }
            set { _ComponentesExtras = value; }
        }
        ...
        private string _NumPlaza;
        public string NumPlaza
        {
            get { return _NumPlaza.Trim(); }
            set { _NumPlaza = value.Trim(); }
        }

        private string _TipoPersonal;
        public string TipoPersonal
        {
            get { return _TipoPersonal.Trim(); }
            set { _TipoPersonal = value.Trim(); }
        }

        private string _Evento_Exclusivo="N";
        public string Evento_Exclusivo
        {
            get { return _Evento_Exclusivo.Trim(); }
            set { _Evento_Exclusivo = value.Trim(); }
        }
