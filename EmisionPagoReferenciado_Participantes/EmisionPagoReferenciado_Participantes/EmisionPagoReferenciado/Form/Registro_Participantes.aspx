    ...
    <div class="container-fluid">
                ...
                <ul class="stepper stepper-horizontal">
                    ...
                    <li class="active">
                        <a href="#!">
                            ...
                            <span class="label" style="color: #5f5f5f">Usuario</span>
                        </a>
                    </li>
        ...
        <div class="row  d-md-none">
            <ul class="nav nav-tabs step-anchor">
                <li class="nav-item active font-weight-bold" style="background-color: #d2d2d2"><a href="" class="nav-link">Paso 1<br>
            ...
            <ContentTemplate>
                <asp:Panel ID="pnlParticipante_Gral" runat="server">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <asp:TextBox ID="txtNombre_Gral" runat="server" TabIndex="200" AutoPostBack="True" onkeypress="if (event.keyCode==13) return false;" OnTextChanged="txtNombre_Gral_TextChanged" CssClass="form-control"></asp:TextBox>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <asp:TextBox ID="txtPaterno_Gral" runat="server" TabIndex="201" CssClass="form-control" onkeypress="if (event.keyCode==13) return false;"></asp:TextBox>
                        ...
                        <div class="col-md-4">
                            <asp:TextBox ID="txtMaterno_Gral" runat="server" OnTextChanged="txtMaterno_Gral_TextChanged"
                                AutoPostBack="True" TabIndex="202" CssClass="form-control" onkeypress="if (event.keyCode==13) return false;"></asp:TextBox>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <asp:TextBox ID="txtCiudad_Gral" runat="server" TabIndex="211" CssClass="form-control" onkeypress="if (event.keyCode==13) return false;"></asp:TextBox>
                        </div>
                    </div>
                    <br />
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <asp:TextBox ID="txtDomicilio_Gral" runat="server" TabIndex="212" CssClass="form-control" onkeypress="if (event.keyCode==13) return false;"></asp:TextBox>
                        </div>
                    </div>
                    <br />
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <asp:TextBox ID="txtColonia_Gral" runat="server" TabIndex="213" CssClass="form-control" onkeypress="if (event.keyCode==13) return false;"></asp:TextBox>
                        </div>
                    </div>
                    <br />
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <asp:TextBox ID="txtTelefono_Gral" runat="server" TabIndex="214" CssClass="form-control" onkeypress="if (event.keyCode==13) return false;"></asp:TextBox>
                        </div>
                        ...
                        <div class="col-md-4">
                            <asp:TextBox ID="txtCel_Gral" runat="server" TabIndex="215" CssClass="form-control" onkeypress="if (event.keyCode==13) return false;"></asp:TextBox>
                        </div>
                    </div>
                    <br />
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <asp:TextBox ID="txtInstitucion_Gral" runat="server" TabIndex="216" CssClass="form-control" onkeypress="if (event.keyCode==13) return false;"></asp:TextBox>
                        </div>
                    </div>
                    <br />
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <asp:TextBox ID="txtCargo_Puesto" runat="server" TabIndex="217" CssClass="form-control" onkeypress="if (event.keyCode==13) return false;"></asp:TextBox>
                        </div>
                    </div>
                    <br />
                    <div class="row">
        ...
        <div class="modal-dialog modal-login">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Antes de acudir a las oficinas de <strong>servicios escolares</strong> a realizar alguno de los trámites y servicios que se presentan verifica los requisitos en la página <a href="https://siae.unach.mx/escolares/" target="_blank">https://siae.unach.mx/escolares/</a>
                </div>
