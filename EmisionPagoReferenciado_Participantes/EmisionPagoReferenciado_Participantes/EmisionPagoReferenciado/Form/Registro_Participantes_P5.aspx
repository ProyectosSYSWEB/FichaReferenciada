...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%--<div class="container">
        <div class="row">
            <div class="col text-center">
                <h5>
                    <asp:Label ID="lblTitulo" runat="server" Text="FICHA REFERENCIADA"></asp:Label></h5>
            </div>
        </div>
    </div>--%>
    <div class="container">
    ...
    <div class="contenedor_botones" align="center">
        ...
        &nbsp;<asp:Button ID="btnForma_Pago" runat="server" CssClass="btn btn-primary" Text="Siguiente"
