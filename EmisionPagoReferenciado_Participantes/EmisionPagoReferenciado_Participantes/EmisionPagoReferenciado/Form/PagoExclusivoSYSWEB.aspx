<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PagoExclusivoSYSWEB.aspx.cs" Inherits="EmisionPagoReferenciado.Form.PagoExclusivoSYSWEB" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fluid" id="InfPagoRef" runat="server">
        <div class="row">
            <div class="col text-center">
    ...
    <div class="container-fluid" id="AccesoDen" runat="server" visible="false">
        <div class="row">
